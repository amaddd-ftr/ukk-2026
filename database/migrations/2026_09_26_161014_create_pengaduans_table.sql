...
CONSTRAINT `fk_pengaduan_siswa` FOREIGN KEY (`id_siswa`) REFERENCES `siswa` (`id_siswa`) ON DELETE RESTRICT ON UPDATE CASCADE,

CONSTRAINT `fk_pengaduan_sarpras` FOREIGN KEY (`id_sarpras`) REFERENCES `sarpras` (`id_sarpras`) ON DELETE RESTRICT ON UPDATE CASCADE,
